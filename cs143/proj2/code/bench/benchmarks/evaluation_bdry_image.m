...
for t = 1:nthresh,
    ...
    for i = 1:numel(groundTruth),
        ...
        %if (i==1)            figure;subplot(121);imshow(bmap);subplot(122);imshow(double(groundTruth{i}.Boundaries));title(thresh(t));end
        
        [match1,match2] = correspondPixels(bmap, double(groundTruth{i}.Boundaries), maxDist);
        
        %if (i==1)          figure;subplot(121);imshow(match1);subplot(122);imshow(match2);end
