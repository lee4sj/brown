...
.data
    ...
    GENERATIONS         = 10         # number of generations to render
    ROWS                = 10         # width of the board (no. of cells)
    COLUMNS             = 10        # height of the board (no. of cells)
    ARRAY_SIZE          = 100        # area of board (must be ROWS * COLUMNS,
...
add_cells_for_testing:
		...
		li	$a1, 4
		li	$a2, 4
		jal add_live_cell			# add_live_cell(board, 0, 9)
		li	$a1, 5
		li	$a2, 5
		jal add_live_cell			# add_live_cell(board, 0, 9)
		li	$a1, 6
