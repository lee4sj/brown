...
public class MIPSCodeGenerator {
	 ...
	 * @param reg Register that will be changed
	 */
	public void genLoadAddress(String id, Register reg){
		_codeString +=
  		"\tla\t$" +
  		getRegNumber(reg) +
  		", " +
	...
	public void genLoadReg(Register destination, Register address){
		_codeString +=
  		"\tlw\t$" +
  		getRegNumber(destination) +
  		", ($" + getRegNumber(address) + ")\n";
	}

	public void genStoreReg(Register sourse, Register address){
		_codeString +=
  		"\tsw\t$" +
  		getRegNumber(sourse) +
  		", ($" + getRegNumber(address) + ")\n";
