...
static htable_node_t *__htable_lookup( htable_t *ht, unsigned long id );

/* initialize the hash table */
void htable_init( htable_t *ht, unsigned long cap ) {
	unsigned long i;
...
/* free the htable_node_t's from the hashtable. calling this implies
   that one has already freed the data that these nodes pointto, 
...
void *htable_get( htable_t *ht, unsigned long id ) {
	htable_node_t *hn;
...
void *htable_put( htable_t *ht, unsigned long id, void *data ) { 
	htable_node_t *hn;
	void *old = NULL;
...
void *htable_remove( htable_t *ht, unsigned long id ) {
	htable_node_t *hn;
...
htable_node_t *__htable_lookup( htable_t *ht, unsigned long id ) {
	htable_node_t *hn;
