...
/* 1568 */   private static final float cos3_64 = (float)(1.0D / (2.0D * Math.cos(0.1472621556370216D)));
...
/* 1571 */   private static final float cos9_64 = (float)(1.0D / (2.0D * Math.cos(0.4417864669110647D)));
...
/* 1578 */   private static final float cos23_64 = (float)(1.0D / (2.0D * Math.cos(1.129009859883832D)));
...
/* 1583 */   private static final float cos1_32 = (float)(1.0D / (2.0D * Math.cos(0.09817477042468104D)));
/* 1584 */   private static final float cos3_32 = (float)(1.0D / (2.0D * Math.cos(0.294524311274043D)));
...
/* 1588 */   private static final float cos11_32 = (float)(1.0D / (2.0D * Math.cos(1.079922474671491D)));
/* 1589 */   private static final float cos13_32 = (float)(1.0D / (2.0D * Math.cos(1.276272015520854D)));
/* 1590 */   private static final float cos15_32 = (float)(1.0D / (2.0D * Math.cos(1.472621556370215D)));
/* 1591 */   private static final float cos1_16 = (float)(1.0D / (2.0D * Math.cos(0.1963495408493621D)));
/* 1592 */   private static final float cos3_16 = (float)(1.0D / (2.0D * Math.cos(0.5890486225480862D)));
/* 1593 */   private static final float cos5_16 = (float)(1.0D / (2.0D * Math.cos(0.9817477042468104D)));
/* 1594 */   private static final float cos7_16 = (float)(1.0D / (2.0D * Math.cos(1.374446785945535D)));
/* 1595 */   private static final float cos1_8 = (float)(1.0D / (2.0D * Math.cos(0.3926990816987241D)));
/* 1596 */   private static final float cos3_8 = (float)(1.0D / (2.0D * Math.cos(1.178097245096172D)));
...
/*      */     {
/*      */       float tmp16_15 = 0.0F; this.v2[p] = tmp16_15; this.v1[p] = tmp16_15;
/*      */     }
/*      */ 
...
/*      */     float new_v2;
/*      */     float new_v1;
/*  197 */     float new_v0 = new_v1 = new_v2 = new_v3 = new_v4 = new_v5 = new_v6 = new_v7 = new_v8 = new_v9 = 
...
/*      */ 
/*  330 */     float new_v19 = -(new_v4 = (new_v12 = p7) + p5) - p6;
/*  331 */     float new_v27 = -p6 - p7 - p4;
/*  332 */     float new_v6 = (new_v10 = (new_v14 = p15) + p11) + p13;
/*  333 */     float new_v17 = -(new_v2 = p15 + p13 + p9) - p14;
/*      */     float tmp1;
/*  334 */     float new_v21 = (tmp1 = -p14 - p15 - p10 - p11) - p13;
/*  335 */     float new_v29 = -p14 - p15 - p12 - p8;
/*  336 */     float new_v25 = tmp1 - p12;
/*  337 */     float new_v31 = -p0;
/*  338 */     new_v0 = p1;
/*  339 */     float new_v23 = -(new_v8 = p3) - p2;
/*      */ 
...
/*      */ 
/*  434 */     float new_v5 = (new_v11 = (new_v13 = (new_v15 = p15) + p7) + p11) + 
/*  435 */       p5 + p13;
/*  436 */     float new_v7 = (new_v9 = p15 + p11 + p3) + p13;
/*  437 */     float new_v16 = -(new_v1 = (tmp1 = p13 + p15 + p9) + p1) - p14;
/*  438 */     float new_v18 = -(new_v3 = tmp1 + p5 + p7) - p6 - p14;
/*      */ 
/*  440 */     float new_v22 = (tmp1 = -p10 - p11 - p14 - p15) - 
/*  441 */       p13 - p2 - p3;
/*  442 */     float new_v20 = tmp1 - p13 - p5 - p6 - p7;
/*  443 */     float new_v24 = tmp1 - p12 - p2 - p3;
/*      */     float tmp2;
/*  444 */     float new_v26 = tmp1 - p12 - (tmp2 = p4 + p6 + p7);
/*  445 */     float new_v30 = (tmp1 = -p8 - p12 - p14 - p15) - p0;
/*  446 */     float new_v28 = tmp1 - tmp2;
/*      */ 
...
/*      */     float tmp1175_1174 = ((new_v[12] = p[7]) + p[5]); new_v[4] = tmp1175_1174; new_v[19] = (-tmp1175_1174 - p[6]);
/*  689 */     new_v[27] = (-p[6] - p[7] - p[4]);
/*      */     float tmp1222_1221 = ((new_v[14] = p[15]) + p[11]); new_v[10] = tmp1222_1221; new_v[6] = (tmp1222_1221 + p[13]);
/*      */     float tmp1249_1248 = (p[15] + p[13] + p[9]); new_v[2] = tmp1249_1248; new_v[17] = (-tmp1249_1248 - p[14]);
/*      */     long tmp1281_1280 = (-p[14] - p[15] - p[10] - p[11]); float tmp1 = tmp1281_1280; new_v[21] = (tmp1281_1280 - p[13]);
/*  693 */     new_v[29] = (-p[14] - p[15] - p[12] - p[8]);
/*  694 */     new_v[25] = (tmp1 - p[12]);
/*  695 */     new_v[31] = (-p[0]);
/*  696 */     new_v[0] = p[1];
/*      */     float tmp1348_1347 = p[3]; new_v[8] = tmp1348_1347; new_v[23] = (-tmp1348_1347 - p[2]);
/*      */ 
...
/*      */     float tmp2565_2564 = ((new_v[13] = (new_v[15] = p[15]) + p[7]) + p[11]); new_v[11] = tmp2565_2564; new_v[5] = 
/*  793 */       (tmp2565_2564 + 
/*  793 */       p[5] + p[13]);
/*      */     float tmp2596_2595 = (p[15] + p[11] + p[3]); new_v[9] = tmp2596_2595; new_v[7] = (tmp2596_2595 + p[13]);
/*      */     float tmp2630_2629 = ((tmp1 = p[13] + p[15] + p[9]) + p[1]); new_v[1] = tmp2630_2629; new_v[16] = (-tmp2630_2629 - p[14]);
/*      */     float tmp2655_2654 = (tmp1 + p[5] + p[7]); new_v[3] = tmp2655_2654; new_v[18] = (-tmp2655_2654 - p[6] - p[14]);
/*      */     long tmp2692_2691 = (-p[10] - p[11] - p[14] - p[15]); tmp1 = tmp2692_2691; new_v[22] = 
/*  799 */       (tmp2692_2691 - 
/*  799 */       p[13] - p[2] - p[3]);
/*  800 */     new_v[20] = (tmp1 - p[13] - p[5] - p[6] - p[7]);
/*  801 */     new_v[24] = (tmp1 - p[12] - p[2] - p[3]);
/*      */     float tmp2776_2775 = (p[4] + p[6] + p[7]); float tmp2 = tmp2776_2775; new_v[26] = (tmp1 - p[12] - tmp2776_2775);
/*      */     long tmp2804_2803 = (-p[8] - p[12] - p[14] - p[15]); tmp1 = tmp2804_2803; new_v[30] = (tmp2804_2803 - p[0]);
 ...
 * Qualified Name:     javazoom.jl.decoder.SynthesisFilter
