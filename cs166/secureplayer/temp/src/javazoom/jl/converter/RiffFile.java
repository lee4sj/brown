...
/*     */         try
/*     */         {
/* 141 */           this.file = new RandomAccessFile(Filename, "r");
/*     */           try
/*     */           {
/* 145 */             byte[] br = new byte[8];
/* 146 */             this.file.read(br, 0, 8);
/* 147 */             this.fmode = 2;
/* 148 */             this.riff_header.ckID = (br[0] << 24 & 0xFF000000 | br[1] << 16 & 0xFF0000 | br[2] << 8 & 0xFF00 | br[3] & 0xFF);
/* 149 */             this.riff_header.ckSize = (br[4] << 24 & 0xFF000000 | br[5] << 16 & 0xFF0000 | br[6] << 8 & 0xFF00 | br[7] & 0xFF);
/*     */           }
/*     */           catch (IOException ioe) {
/* 152 */             this.file.close();
/* 153 */             this.fmode = 0;
...
/*     */     case 1:
/* 474 */       return "DDC_FAILURE";
/*     */     case 2:
/* 475 */       return "DDC_OUT_OF_MEMORY";
/*     */     case 3:
/* 476 */       return "DDC_FILE_ERROR";
/*     */     case 4:
/* 477 */       return "DDC_INVALID_CALL";
/*     */     case 5:
/* 478 */       return "DDC_USER_ABORT";
/*     */     case 6:
/* 479 */       return "DDC_INVALID_FILE";
/*     */     }
 ...
 * Qualified Name:     javazoom.jl.converter.RiffFile
