...
/*     */ 
/*  65 */     if (device != null) this.audio = device; else
/*  66 */       this.audio = FactoryRegistry.systemRegistry().createAudioDevice();
 ...
 * Qualified Name:     javazoom.jl.player.advanced.AdvancedPlayer
