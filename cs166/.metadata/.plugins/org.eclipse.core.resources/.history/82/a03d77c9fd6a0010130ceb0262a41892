...
/*     */ 
/*  82 */   private static int[][] ValTab4 = { new int[2] };
/*     */ 
...
/* 465 */     if (h.treelen == 0)
/*     */     {
/*     */       int tmp39_38 = 0; y[0] = tmp39_38; x[0] = tmp39_38;
/* 468 */       return 0;
/*     */     }
/*     */ 
/*     */     do
...
/*     */       {
/* 499 */         while (h.val[point][1] >= 250) point += h.val[point][1];
/* 500 */         point += h.val[point][1];
/*     */       }
/*     */       else
/*     */       {
/* 504 */         while (h.val[point][0] >= 250) point += h.val[point][0];
 ...
 * Qualified Name:     javazoom.jl.decoder.huffcodetab
