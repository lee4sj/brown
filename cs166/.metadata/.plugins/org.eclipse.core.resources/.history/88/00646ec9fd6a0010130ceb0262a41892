...
/*  71 */   private double[] h_vbr_time_per_frame = { -1.0D, 384.0D, 1152.0D, 1152.0D };
...
/*     */     int headerstring;
/*     */     do {
/* 122 */       headerstring = stream.syncHeader(this.syncmode);
...
/*     */     {
/* 250 */       if (this.h_mode == 3) offset = 17; else {
/* 251 */         offset = 32;
/*     */       }
/*     */ 
/*     */     }
/* 255 */     else if (this.h_mode == 3) offset = 9; else {
/* 256 */       offset = 17;
/*     */     }
/*     */     try
/*     */     {
...
/*     */   {
/* 382 */     return this.h_protection_bit == 0;
/*     */   }
/*     */ 
...
/*     */   {
/* 426 */     return this.h_padding_bit != 0;
/*     */   }
/*     */ 
/*     */   public int slots()
/*     */   {
...
/*     */     {
/* 475 */       this.framesize = 
/* 476 */         (12 * bitrates[this.h_version][0][this.h_bitrate_index] / 
/* 476 */         frequencies[this.h_version][this.h_sample_frequency]);
/* 477 */       if (this.h_padding_bit != 0) this.framesize += 1;
...
/*     */     {
/* 483 */       this.framesize = 
/* 484 */         (144 * bitrates[this.h_version][(this.h_layer - 1)][this.h_bitrate_index] / 
/* 484 */         frequencies[this.h_version][this.h_sample_frequency]);
/* 485 */       if ((this.h_version == 0) || (this.h_version == 2)) this.framesize >>= 1;
/* 486 */       if (this.h_padding_bit != 0) this.framesize += 1;
/*     */ 
...
/*     */         {
/* 492 */           this.nSlots = 
/* 494 */             (this.framesize - (this.h_mode == 3 ? 17 : 32) - (
...
/*     */         {
/* 498 */           this.nSlots = 
/* 500 */             (this.framesize - (this.h_mode == 3 ? 9 : 17) - (
