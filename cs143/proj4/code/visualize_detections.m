function visualize_detections(bboxes, confidences, image_ids, onlytp)
...
test_img_path = '/course/cs143/data/proj4/test_scenes/test_jpg';
...
for d=1:nd
    ...
    % read image
    I=imread( fullfile( test_img_path, image_ids{d}) );
