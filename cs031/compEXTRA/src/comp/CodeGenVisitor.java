...
/*
	public void handleNodeInstrDeclPointer(NodeInstrDeclPointer node) throws VisitorException{
		...
		//set this variable as the pointer.
		_codegen.genLoadAddress(node.val().identifier(), Register.T0);		// load the address
		_codegen.genStore(node.identifier(), Register.T0);					// store the address
	...
	public void handleNodeExprArrayVarPointer(NodeExprArrayVarPointer node) throws VisitorException{
        ...
        _codegen.genLoadAddress(node.variable(), Register.T1);	// load the address of the array
		_codegen.genPlus(Register.T1, Register.T0);				// add the offset to the address of the array
        _codegen.genPush(Register.T1);							// push to the stack
	}


	public void handleNodeExprVarPointer(NodeExprVarPointer node) throws VisitorException{
		_codegen.genLoadAddress(node.variable(), Register.T0);		//load the address of the variable
        _codegen.genPush(Register.T0);								// push to the stack
	}
	...
	public void handleNodeExprVarDeref(NodeExprVarDeref node) throws VisitorException{
		...
		_codegen.genLoad(node.variable(), Register.T0);			//load the value of the variable
		_codegen.genLoadReg(Register.T1, Register.T0);			//load the value stored at the value of the variable
        _codegen.genPush(Register.T1);							// push to the stack
	}
	...
	public void handleNodeExprArrayVarDeref(NodeExprArrayVarDeref node) throws VisitorException{
        ...
        _codegen.genLoadIndirect(node.variable(), Register.T1, Register.T0);	// load the value in the array at the index (let's call this valAd)

		_codegen.genLoadReg(Register.T0, Register.T1);							// load the value stored at the address of valAd
		_codegen.genPush(Register.T0);											// push to teh stack
	...
	public void handleNodeInstrAssignSinglePointer(NodeInstrAssignSinglePointer node) throws VisitorException{
		...
		//storing the expression to the &variable
		_codegen.genPop(Register.T1);								//load the expression

		_codegen.genLoad(node.identifier(), Register.T0);			//load the address to store the expression
		_codegen.genStoreReg(Register.T1, Register.T0);				//store the expression addressed at the value of the variable

		//storing the address to the variable
		_codegen.genStore(node.identifier(), Register.T0);
	}
	...
	public void handleNodeInstrAssignArrayPointer(NodeInstrAssignArrayPointer node) throws VisitorException{
		...
		_codegen.genLoadIndirect(node.identifier(), Register.T2, Register.T0);	// load the address to store the expression
		_codegen.genStoreReg(Register.T1, Register.T2);							// store the expression to the loaded address

		//storing the address to the variable
        _codegen.genStoreIndirect(node.identifier(), Register.T2, Register.T0);
	}
}
